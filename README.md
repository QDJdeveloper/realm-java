 ...
 * If you'd like to specify the location in which to store the archives of Realm's core, define the `REALM_CORE_DOWNLOAD_DIR` environment variable. It enables you to keep core's archive when executing `git clean -xfd`.
